...
import HomeHero from '../../Home/Components/Hero/Hero';
...
class HomePage extends Component {
  render() {
    ...
    return (
      <React.Fragment>
        <div className="inner-container section--jobs section section--featured">
        ...
        <div className="inner-container section--companies section section--featured">
          <div className="content">
            <header className="flex items-center">
