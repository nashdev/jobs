...
const SLACK_CLIENT_ID = `${process.env.SLACK_CLIENT_ID_PREFIX}.${
  process.env.SLACK_CLIENT_ID_SUFFIX
}`;
        ...
        <header className={s.masthead}>
          ...
          {!me && (
            <nav className={`${s.user} ${s.inline}`}>
              <a
                href={`https://slack.com/oauth/authorize?scope=identity.basic,identity.email,identity.team,identity.avatar&client_id=${SLACK_CLIENT_ID}`}
              >
                <span>
